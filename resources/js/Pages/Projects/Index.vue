        ...
        <data-table :filters="filters"
            ...
            <template v-slot:default="slotProp">
                <div v-if="slotProp.item.deleted_at === 'Active'">
                    <Link :href="route('projects.assign.clients.form', slotProp.item)"
                          as="v-btn"
                          color="black"
                          icon
                          small
                    ...
                    <Link :href="route('projects.show', slotProp.item)"
                          as="v-btn"
                          color="success"
                          icon
                          small
                    ...
                    <Link :href="route('projects.edit', slotProp.item)"
                          as="v-btn"
                          color="accent"
                          icon
                          small
                    ...
                    <Link :href="route('projects.destroy', slotProp.item)"
                          as="v-btn"
                          color="warning"
                          icon
                          method="delete"
                ...
                <div v-else>
                    <Link :href="route('projects.restore', slotProp.item)"
                          as="v-btn"
                          color="success"
                          icon
                          method="post"
...
export default {
    ...
    data() {
        return {
            headers: [
                ...
                {text: 'Start Date', value: 'starting_date'},
    ...
    methods: {
        ...
        deleteItemConfirm() {
            ...
            Inertia.delete(this.route('projects.force.delete', this.itemId));
        }
    }
}
</script>
